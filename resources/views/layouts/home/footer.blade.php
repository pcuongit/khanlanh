        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3">
                <a href="" title="MIỄN PHÍ VẬN CHUYỂN">
                    <div class="about_me_item wow fadeInRight animated" data-wow-duration="1s"
                        style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                        <div class="about_me_img">
                            <img src="{{asset('home/custom/icon/icons8-truck-30-6532.png')}}" alt="MIỄN PHÍ VẬN CHUYỂN">
                        </div>
                        <div class="about_me_mota">
                            <h3 style="color: #222;">MIỄN PHÍ VẬN CHUYỂN</h3>
                            <p style="color: #222;">Nhận hàng trong vòng 3 ngày</p>
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <a href="" title="CHẤT LƯỢNG ĐẢM BẢO">
                    <div class="about_me_item wow fadeInRight animated" data-wow-duration="1s"
                        style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                        <div class="about_me_img">
                            <img src="{{asset('home/custom/icon/policy_icon_2-8520.png')}}" alt="CHẤT LƯỢNG ĐẢM BẢO">
                        </div>
                        <div class="about_me_mota">
                            <h3 style="color: #222;">CHẤT LƯỢNG ĐẢM BẢO</h3>
                            <p style="color: #222;">Top 10 thương hiệu uy tín 2017</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </a>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <a href="" title="HỖ TRỢ 24/7">
                    <div class="about_me_item wow fadeInRight animated" data-wow-duration="1s"
                        style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                        <div class="about_me_img">
                            <img src="{{asset('home/custom/icon/policy_icon_3-8092.png')}}" alt="HỖ TRỢ 24/7">
                        </div>
                        <div class="about_me_mota">
                            <h3 style="color: #222;">HỖ TRỢ 24/7</h3>
                            <p style="color: #222;">Gọi điện - Zalo - iMessage - SMS</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </a>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <a href="" title="ĐỔI TRẢ DỄ DÀNG">
                    <div class="about_me_item wow fadeInRight animated" data-wow-duration="1s"
                        style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                        <div class="about_me_img">
                            <img src="{{asset('home/custom/icon/repeat-9798.png')}}" alt="ĐỔI TRẢ DỄ DÀNG">
                        </div>
                        <div class="about_me_mota">
                            <h3 style="color: #222;">ĐỔI TRẢ DỄ DÀNG</h3>
                            <p style="color: #222;">Trả lại hàng nếu không ưng ý</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </a>
...
<div id="w_footer">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 text-center">
                    <div class="logo_footer  wow fadeIn animated" data-duration="1s"
                        ...
                        <img src="{{asset('home/custom/images/logo.jpg')}}" alt="Công Ty Khăn Lạnh Toàn Phát"
                            height="75px">
                    </div>
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="tt_footer wow fadeIn animated" data-duration="1s"
                        style="visibility: visible; animation-name: fadeIn;">
    ...
    <img class="scroll-top" id="scroll-top" onClick="topFunction()" src="{{asset('home/custom/icon/totop.png')}}"
        style="cursor: pointer; position: fixed; bottom: 20px; right: 20px; z-index: 99999;">
    <!---END #footer-->
